...
# Build profiles: per-domain weighting for the multi-domain ablation methodology.
# See docs/multi_domain_ablation.md. Used when ablation_results.json has the
# new schema (per-domain PPL dicts). Old single-value schema ignores these.
DEFAULT_PROFILES = {
